describe("Standard User Flows", () => {
    before(() => {
        // Navigate and login into Sauce Demo
    ...
    it("should add/remove an item to the cart", () => {
      ...
      cy.get("#last-name").type("Herrera"); // Here fails, so everything following this step fails as well.
